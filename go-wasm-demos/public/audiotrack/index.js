...
PCMPlayer.prototype.playNext = function (samplesLeft, samplesRight) {
    var audioBuffer = this.ctx.createBuffer(this.numChannels, samplesLeft.length, this.sampleRate);
...
(() => {
    ...
    const go = new Go();
    let mod, inst;
    WebAssembly.instantiateStreaming(fetch("https://mgnsk.github.io/go-wasm-demos/public/audiotrack/audiotrack.wasm"), go.importObject).then((result) => {
        mod = result.module;
